...
- Name: apps\web\e2e\membership-governance.spec.ts >> Fair Membership Governance — Accessibility >> recruiter workspace with membership section passes axe audit
- Location: apps\web\e2e\membership-governance.spec.ts:189:3
