...
- Name: apps\web\e2e\membership-governance.spec.ts >> Fair Membership Governance — Recruiter Invitation Flow >> admin can invite recruiter by email and recruiter can accept invitation to open booth
- Location: apps\web\e2e\membership-governance.spec.ts:11:3
