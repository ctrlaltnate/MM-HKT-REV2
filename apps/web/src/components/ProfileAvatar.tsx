export function ProfileAvatar({ seed, size = 44, ariaHidden }: { seed: string; size?: number; ariaHidden?: boolean }) {
  ...
  return ariaHidden ? (
    <svg className="profile-avatar" width={size} height={size} viewBox="0 0 48 48" aria-hidden="true" shapeRendering="crispEdges">
