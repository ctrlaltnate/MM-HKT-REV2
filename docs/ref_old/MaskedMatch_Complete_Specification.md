...
> **Archived entrypoint:** เก็บไว้เพื่ออ้างอิงประวัติเท่านั้น กรุณาใช้ [Master Documentation Index](../README.md) สำหรับสถานะปัจจุบัน
...
- [07-playbooks-and-operations/architecture-decision-records.md](../07-playbooks-and-operations/architecture-decision-records.md) — บันทึกการตัดสินใจทางสถาปัตยกรรม (ADR-001 ถึง ADR-012)
